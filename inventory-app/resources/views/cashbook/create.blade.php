            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control @error('type') is-invalid @enderror" 
                        ...
                        <option value="receipt" @selected(old('type') == 'receipt')>Receipt (Income)</option>
                        <option value="payment" @selected(old('type') == 'payment')>Payment (Expense)</option>
                    </select>
                    @error('type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('from_to') is-invalid @enderror" 
                           id="from_to" name="from_to" value="{{ old('from_to') }}" placeholder="Person/Company name" required>
                    @error('from_to')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
