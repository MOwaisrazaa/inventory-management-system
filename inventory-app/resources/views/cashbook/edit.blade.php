            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control @error('type') is-invalid @enderror" 
                        ...
                        <option value="receipt" @selected($cashBook->type == 'receipt')>Receipt</option>
                        <option value="payment" @selected($cashBook->type == 'payment')>Payment</option>
                    </select>
                    @error('type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control @error('payee_type') is-invalid @enderror" 
                        ...
                        <option value="customer" @selected(old('payee_type', $cashBook->payee_type) == 'customer')>Customer</option>
                        <option value="vendor" @selected(old('payee_type', $cashBook->payee_type) == 'vendor')>Vendor</option>
                    </select>
                    @error('payee_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6 mb-3" id="customer_dropdown" style="display: {{ old('payee_type', $cashBook->payee_type) == 'customer' ? 'block' : 'none' }};">
                    <label for="customer_id" class="form-label">Customer <span class="text-danger">*</span></label>
                    <select class="form-control @error('customer_id') is-invalid @enderror" 
                            id="customer_id" name="customer_id">
                        <option value="">Select Customer</option>
                        @foreach($customers as $customer)
                            <option value="{{ $customer->id }}" @selected(old('customer_id', $cashBook->customer_id) == $customer->id)>
                                {{ $customer->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3" id="vendor_dropdown" style="display: {{ old('payee_type', $cashBook->payee_type) == 'vendor' ? 'block' : 'none' }};">
                    <label for="vendor_id" class="form-label">Vendor <span class="text-danger">*</span></label>
                    <select class="form-control @error('vendor_id') is-invalid @enderror" 
                            id="vendor_id" name="vendor_id">
                        <option value="">Select Vendor</option>
                        @foreach($vendors as $vendor)
                            <option value="{{ $vendor->id }}" @selected(old('vendor_id', $cashBook->vendor_id) == $vendor->id)>
                                {{ $vendor->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('description') is-invalid @enderror" 
                           id="description" name="description" value="{{ old('description', $cashBook->description) }}" required>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control @error('item_id') is-invalid @enderror" 
                        ...
                        @foreach($items as $item)
                            <option value="{{ $item->id }}" @selected(old('item_id', $cashBook->item_id) == $item->id)>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('amount') is-invalid @enderror" 
                           id="amount" name="amount" value="{{ old('amount', $cashBook->amount) }}" required>
                    @error('amount')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="notes" name="notes" value="{{ old('notes', $cashBook->notes) }}">
                </div>
            </div>
