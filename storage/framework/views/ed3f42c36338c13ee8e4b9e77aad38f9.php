...
unset($__errorArgs, $__bag); ?>" 
                           id="sku" name="sku" value="<?php echo e(old('sku', $item->sku)); ?>" required>
                    <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" 
                          id="description" name="description" rows="3"><?php echo e(old('description', $item->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                           id="purchase_price" name="purchase_price" value="<?php echo e(old('purchase_price', $item->purchase_price)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                           id="selling_price" name="selling_price" value="<?php echo e(old('selling_price', $item->selling_price)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                           id="quantity" name="quantity" value="<?php echo e(old('quantity', $item->quantity)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="unit" name="unit" required>
                    ...
                    <option value="Kg" <?php echo e(old('unit', $item->unit) == 'Kg' ? 'selected' : ''); ?>>Kg</option>
                    ...
                    <option value="Dozen" <?php echo e(old('unit', $item->unit) == 'Dozen' ? 'selected' : ''); ?>>Dozen</option>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\inventory-app\resources\views/items/edit.blade.php ENDPATH**/ ?>